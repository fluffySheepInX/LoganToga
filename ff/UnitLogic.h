...
namespace ff
{
 ...
 bool SpawnAlly(Array<Ally>& allies, const TerrainGrid& terrain, const Vec2& playerPos, AllyBehavior behavior);
    int32 UpdateAutoCombat(Array<Ally>& allies, Array<Enemy>& enemies, const Vec2& playerPos, double& playerHp, Array<Enemy>* defeatedEnemies = nullptr, bool canDamagePlayer = true, bool* playerWasHit = nullptr, CombatTelemetry* combatTelemetry = nullptr);
