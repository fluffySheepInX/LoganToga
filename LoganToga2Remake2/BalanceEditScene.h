...
private:
	...
	void drawTextRow(int32 rowIndex, const String& label, const String& valueText, const Font& font) const;
	...
	[[nodiscard]] static String getCardsOverridePath();
	...
	[[nodiscard]] static String toRewardCardStatTypeDisplayString(RewardCardStatType statType);
