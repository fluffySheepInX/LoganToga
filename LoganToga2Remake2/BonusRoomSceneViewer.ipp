...
void BonusRoomScene::drawViewer() const
{
 ...
 data.smallFont(Localization::FormatText(U"bonus_room.viewer.page", progress.activePageIndex + 1, room->pages.size())).drawAt(Scene::CenterF().movedBy(0, -192), Palette::Yellow);
