...
void BonusRoomScene::drawGallery() const
{
 ...
 data.titleFont(Localization::GetText(U"bonus_room.gallery.title")).drawAt(Scene::CenterF().movedBy(0, -250), Palette::White);
	data.uiFont(Localization::GetText(U"bonus_room.gallery.subtitle")).drawAt(Scene::CenterF().movedBy(0, -205), ColorF{ 0.84, 0.90, 1.0 });
	data.smallFont(Localization::FormatText(U"bonus_room.gallery.viewed_count", rooms.size(), data.bonusRooms.size())).drawAt(Scene::CenterF().movedBy(0, -172), Palette::Yellow);
