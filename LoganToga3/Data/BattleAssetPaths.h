...
namespace LT3
{
    ...
    inline FilePath ResolveSkillSoundEffectPath(const String& fileName)
    {
        if (fileName.isEmpty())
        {
            return FilePath{};
        ...
        return ResolveAssetPath(
            U"000_Warehouse/000_DefaultGame/047_SkillSe/" + fileName,
            U"App/000_Warehouse/000_DefaultGame/047_SkillSe/" + fileName);
    }
