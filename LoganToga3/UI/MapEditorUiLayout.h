...
namespace LT3
{
    ...
    inline bool SaveBattleUiLayoutToml(MapEditorState& editor, bool updateStatus = true)
    {
        ...
        writer << U"resource_node_editor_x = " << editor.uiResourceNodeEditorPos.x << U"\n";
        writer << U"resource_node_editor_y = " << editor.uiResourceNodeEditorPos.y << U"\n";
        writer << U"decal_editor_x = " << editor.uiDecalEditorPos.x << U"\n";
        writer << U"decal_editor_y = " << editor.uiDecalEditorPos.y << U"\n";
        writer << U"perlin_panel_x = " << editor.uiPerlinNoisePanelPos.x << U"\n";
        writer << U"perlin_panel_y = " << editor.uiPerlinNoisePanelPos.y << U"\n";
        writer << U"z_order_panel_x = " << editor.uiZOrderPanelPos.x << U"\n";
        writer << U"z_order_panel_y = " << editor.uiZOrderPanelPos.y << U"\n";
    ...
    inline void LoadBattleUiLayoutToml(MapEditorState& editor)
    {
        ...
        editor.uiResourceNodeEditorPos.x = toml[U"layout.resource_node_editor_x"].getOr<double>(editor.uiResourceNodeEditorPos.x);
        editor.uiResourceNodeEditorPos.y = toml[U"layout.resource_node_editor_y"].getOr<double>(editor.uiResourceNodeEditorPos.y);
        editor.uiDecalEditorPos.x = toml[U"layout.decal_editor_x"].getOr<double>(editor.uiDecalEditorPos.x);
        editor.uiDecalEditorPos.y = toml[U"layout.decal_editor_y"].getOr<double>(editor.uiDecalEditorPos.y);
        editor.uiPerlinNoisePanelPos.x = toml[U"layout.perlin_panel_x"].getOr<double>(editor.uiPerlinNoisePanelPos.x);
        editor.uiPerlinNoisePanelPos.y = toml[U"layout.perlin_panel_y"].getOr<double>(editor.uiPerlinNoisePanelPos.y);
        editor.uiZOrderPanelPos.x = toml[U"layout.z_order_panel_x"].getOr<double>(editor.uiZOrderPanelPos.x);
        editor.uiZOrderPanelPos.y = toml[U"layout.z_order_panel_y"].getOr<double>(editor.uiZOrderPanelPos.y);
