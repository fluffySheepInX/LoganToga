...
namespace LT3
{
	...
	inline void DrawMusicEditor(const AppSharedData& data)
	{
		...
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, U"music_editor.title")).draw(panel.x + 20, panel.y + 16, Palette::White);
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, U"music_editor.description")).draw(panel.x + 180, panel.y + 18, Palette::Lightgray);
		...
		data.uiFont(FormatLocalizedText(data.localizedTexts, data.defaultTexts, U"music_editor.selected_scene", ToMusicSceneLabel(data.musicEditor.selectedScene))).draw(panel.x + 204, panel.y + 58, Palette::Orange);
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, U"music_editor.file")).draw(panel.x + 204, panel.y + 146, Palette::Lightgray);
		...
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, U"music_editor.volume")).draw(panel.x + 204, panel.y + 188, Palette::Lightgray);
		...
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, IsMusicPreviewPlaying(data.musicEditor) ? U"music_editor.preview_playing" : U"music_editor.preview_stopped")).draw(panel.x + 204, panel.y + 266, Palette::Skyblue);
		data.uiFont(LocalizedText(data.localizedTexts, data.defaultTexts, data.musicEditor.dirty ? U"music_editor.unsaved_changes" : U"music_editor.saved")).draw(panel.x + 204, panel.y + 290, data.musicEditor.dirty ? Palette::Orange : Palette::Lightgreen);
